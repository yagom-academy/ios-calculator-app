...
final class FormulaTests: XCTestCase {
    ...
    func test_result_Operands가비었다며_연산결과는_NaN을반환한다() throws {
        // given
        let expectedOperandsQueue: CalculatorItemQueue<Double> = CalculatorItemQueue()
...
//        let result: Double = try sut.result()
    ...
    func test_result_Operands가1하나만있다면_연산결과는_1을반환한다() throws {
        // given
    ...
    func test_result_operands에1이들어가면_result값으로_1이반환된다() throws {
        // given
    ...
    func test_result_operators에add가들어가면_result는두수를더해_3을반환한다() throws {
        // given
        sut.operands.enqueue(1)
    ...
    func test_result_operators에subtract가들어가면_result는두수를빼서_1을반환한다() throws {
        // given
        sut.operands.enqueue(2)
        sut.operands.enqueue(1)
    ...
    func test_result_operators에multiply가들어가면_result는두수를곱하여_8을반환한다() throws {
        // given
        sut.operands.enqueue(2)
    ...
    func test_result_operators에divide가들어가면_result는두수를나누어_4를반환한다() throws {
        // given
    ...
    func test_result_divide연산에서_0으로나누는경우_NaN을반환한다() throws {
        // given
    ...
    func test_result_3입력을_사칙연산으로계산하면_3을반환한다() throws {
        // given
