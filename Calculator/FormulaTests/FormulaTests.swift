...
//  FormulaTests
//
//  Created by 본프, 수꿍 on 2022/05/23.
//
...
class FormulaTests: XCTestCase {
    ...
    func test_result_연산자와_피연산수가_올바른_순서를_따르지_않을때_오류처리가_정상적으로_이루어지는지_테스트() throws {
        ...
        // then
        XCTAssertThrowsError(try parser.result(), "not enough operators and operands") { error in
            XCTAssertEqual(error as? CalculatorError, CalculatorError.notEnoughOperatorsAndOperands)
        }
    }
