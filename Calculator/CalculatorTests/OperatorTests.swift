...
class OperatorTests: XCTestCase {
    ...
    func test_Double형_10와_Double형_8을_substract_operator로_연산하면_Double형_2점0가_반환되는가() throws {
        // given
        let leftOperand = 10.0
        let rightOperand = 8.0

        // when
        let result = try sutSubtractOperator.calculate(lhs: leftOperand, rhs: rightOperand)

        // then
        XCTAssertEqual(result, 2.0)
    }

    func test_Double형_8와_Double형_10을_substract_operator로_연산하면_Double형_음수_2점0가_반환되는가() throws {
        // given
        let leftOperand = 8.0
    ...
    func test_Double형_80와_Double형_10을_divide_operator로_연산하면_Double형_8점0가_반환되는가() throws {
        // given
    ...
    func test_Double형_80와_Double형_0점0을_divide_operator로_연산하면_notANumber오류가_반환되는가() throws {
        // given
        let leftOperand = 80.0
    ...
    func test_Double형_80와_Double형_10을_multiply_operator로_연산하면_Double형_800점0가_반환되는가() throws {
        ...
        // when
        let result = try sutMultiplyOperator.calculate(lhs: leftOperand, rhs: rightOperand)
