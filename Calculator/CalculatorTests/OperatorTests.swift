...
//MARK: - Operator.calculate
    func test_calculate메서드_덧셈테스트_15더하기9는_24() {
        //given
        let testLhs = 15.0
        let testRhs = 9.0
        ...
        //when
        let result = add.calculate(lhs: testLhs, rhs: testRhs)
        
        //then
        XCTAssertEqual(result, 24)
    }
    
    func test_calculate메서드_뺄셈테스트() {
        //given
        let testLhs = 15.0
        let testRhs = 9.0
