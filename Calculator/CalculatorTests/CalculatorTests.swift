...
class CalculatorTests: XCTestCase {
    ...
    func test_1plus2plus3() {
        ...
        XCTAssertEqual(try sut.calculateAndFormat(), "6")
    }
    ...
    func test_1minus2minus3() {
        sut.replaceInfix(with: ["1", "-", "2", "-", "3"])
        XCTAssertEqual(try sut.calculateAndFormat(), "-4")
    }
    
    func test_1divide2divide3() {
        sut.replaceInfix(with: ["1", "/", "2", "/", "3"])
        XCTAssertEqual(try sut.calculateAndFormat(), "0.16667")
    }
