...
class BinaryCalculationTests: XCTestCase {
    ...
    func test_binaryCalculation_addition() {
        ...
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("000001001"))
    }
    
    func test_binaryCalculation_subtraction() {
        sut_inputDataValidator.data.postfixNotation = ["0101", "~", "1111", "-"]
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("000000000"))
    }
    
    func test_binaryCalculation_overflowTest() {
        sut_inputDataValidator.data.postfixNotation = ["11111111", "10", "+"]
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("100000001"))
    }
    ...
    func test_binaryCalculation_AND_calculation_Test() {
        ...
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("010001000"))
    }
    ...
    func test_binaryCalculation_OR_calculation_Test() {
        sut_inputDataValidator.data.postfixNotation = ["11111111", "10001000", "|"]
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("011111111"))
    }
    ...
    func test_binaryCalculation_XOR_calculation_Test() {
        sut_inputDataValidator.data.postfixNotation = ["11111111", "10001000", "^"]
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("001110111"))
    }
    ...
    func test_binaryCalculation_right_Shift_calculation_Test() {
        ...
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("000011111"))
    }
    
    func test_binaryCalculation_left_Shift_calculation_Test() {
        sut_inputDataValidator.data.postfixNotation = ["00000111", "00000010", "<<"]
        XCTAssertEqual(sut_calculator.executeBinaryCalculation(sut_inputDataValidator.data), .success("000011100"))
    }
