...
class ExpressionParserTests: XCTestCase {
    ...
    func test_피연산자_정상추출되는지(){
        //given
        let inputRawValue: String = "10+20*3/2+3-2*9"
    ...
    func test_숫자2개_연산자1개_계산되는지(){
        //given
        let inputRawValue: String = "99.9+0.1"

        //when
        var resultFormula: Formula = ExpressionParser.parse(from: inputRawValue)
    ...
    func test_숫자3개_연산자3개_계산되는지(){
        //given
        let inputRawValue: String = "99.9+10.1+7-10*0"
